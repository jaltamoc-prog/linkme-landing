...
# v1.011 Landing LinkMe - ruta crear mi linkme
...
@app.route("/")
def index():
    return render_template("index.html", price_usd="29", create_url="https://www.linkme.style/crearmilinkme")
...
def privacidad():
    return render_template("privacidad.html", create_url="https://www.linkme.style/crearmilinkme")

@app.route("/terminos")
def terminos():
    return render_template("terminos.html", create_url="https://www.linkme.style/crearmilinkme")

@app.route("/reembolso")
def reembolso():
    return render_template("reembolso.html", create_url="https://www.linkme.style/crearmilinkme")
